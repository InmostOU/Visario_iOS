...
final class EditContactProfileViewController: UIViewController {
    ...
    private func doneButtonTapped() {
        ...
        viewModel.editContact { [weak self] in
            ...
            self.delegate?.updateProfile(profile: self.viewModel.profile)
    ...
    private func configureView() {
        ...
        profileImageView.sd_setImage(with: URL(string: viewModel.profile.image), placeholderImage: UIImage(named: "profile-icon"))
